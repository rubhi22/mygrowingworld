...
public class GPAcalculator extends JPanel 
{
	...
	private String grade[]={"A+","A","B+","B","C+","C","D+","D","F"};
	private String gradepoints[]={"4.5","4.0","3.5","3.0","2.5","2.0","2.0","1.5","1.0","0"};
	public  String[] comp1={"COMP228","COMP214","GNED500","COMP224","ENGL253","COMP123","COMP226","COMP229","COMP240","MATH185"};
	private JComboBox gradept [] = new JComboBox [comp1.length-1];
	...
	JComboBox grades[]= {new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade),new JComboBox(grade)};
		...
		public void actionPerformed(ActionEvent evt){
			...
			if(evt.getSource() == button){
				...
				for (int index=0; index < noOfCourses;index++){
					...
					if(gradept[index].getSelectedItem().toString().equals("4.5")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("4.0")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("3.5")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("3.0")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("2.5")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("2.0")){
						...
						gpa += (Float.parseFloat("2.0") * Float.parseFloat(hour[index].getSelectedItem().toString())) / Float.parseFloat(hour[index].getSelectedItem().toString());			   
					}else if (gradept[index].getSelectedItem().toString().equals("1.5")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("1.0")){
					...
					}else if (gradept[index].getSelectedItem().toString().equals("0")){
						gpa += (Float.parseFloat("0") * Float.parseFloat(hour[index].getSelectedItem().toString())) / Float.parseFloat(hour[index].getSelectedItem().toString());			   
					}
				}
	...
	public static void main(String[] args) {
		...
		frame.setContentPane(new GPAcalculator());  
