...
public class Java_pad extends JFrame implements ActionListener 
{
    ...
    bar.add( formatMenu );  
      ...
      aboutItem.addActionListener(
         new ActionListener() {
            public void actionPerformed( ActionEvent e )
            {
               JOptionPane.showMessageDialog( Java_pad.this,
