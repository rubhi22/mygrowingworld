<%@ Page Title="" Language="C#" MasterPageFile="~/web229Project.Master" AutoEventWireup="true" CodeBehind="MensJewel.aspx.cs" Inherits="WebProjectMasterPage.MensJewel" %>
...
&nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
        DataSourceID="categoryMensj" DataTextField="Name" DataValueField="CategoryID">
    </asp:DropDownList>
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="gridviewMens" PageSize="4" CellPadding="4" 
    ...
    <br />
    <br />
    <asp:Label ID="Label3" runat="server" Text="Detail View: "></asp:Label>
    <br />
    <br />
&nbsp;
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
        DataKeyNames="ProductID" DataSourceID="DetailMens" Height="50px" 
        Width="125px" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" 
            ...
            <asp:TemplateField HeaderText="Image" SortExpression="Image">
                ...
                <ItemTemplate>
                    <asp:Image ID="Image2" runat="server" 
                        ImageUrl='<%# "Productimages/"+Eval("Image") %>' ForeColor="#884249" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="ProductID" HeaderText="ProductID" 
    ...
    <asp:SqlDataSource ID="DetailMens" runat="server" 
    ...
    <asp:SqlDataSource ID="gridviewMens" runat="server" 
        ConnectionString="<%$ ConnectionStrings:jewellerDatabase13-12-2010 %>" 
        SelectCommand="SELECT [CategoryID], [Price], [ProductID], [Name], [Description], [Thumbnail] FROM [ProdInCat] WHERE ([CategoryID] = @CategoryID)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList1" Name="CategoryID" 
                PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="categoryMensj" runat="server" 
        ConnectionString="<%$ ConnectionStrings:jewellerDatabase13-12-2010 %>" 
